...
pthread_t thread_id;
while((socket_client = accept(socket_server, (struct
sockaddr*)&client_addr, (socklen_t*)&sizeaddr))){
puts("Connection accepted");
if(pthread_create(&thread_id, NULL, todo_client, (void*)&socket_client)
< 0){
...
message="Greetings Kishan Kumar ! I am your connection handler\n";
